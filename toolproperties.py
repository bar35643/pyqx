...
class ToolProperties (QtWidgets.QDockWidget):
    ...
    def createSelectionWidget(self):
        ...
        transparent = QtWidgets.QCheckBox(self.context.getText(
            "tool_properties_selection", "transparent"), self)
    ...
    def createPencilWidget(self):
		...
		"""
        hbox2 = QtWidgets.QHBoxLayout()
        eraser = QtWidgets.QCheckBox(self.context.getText(
            "tool_properties_pencil", "eraser"), self)
    ...
    def createGradientWidget(self):
        ...
        self.btn1 = QtWidgets.QRadioButton(self.context.getText(
            "tool_properties_gradient", "horizontal"))
