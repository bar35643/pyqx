...
class Selection(QtWidgets.QRubberBand):
    ...
    def __init__(self, origin, context, Parent=None):
        ...
        super(Selection, self).__init__(
            QtWidgets.QRubberBand.Rectangle, Parent)
    ...
    def setGeometry(self, x, y, w, h):  # Todos los argumentos son el imagen, no en el Canvas
        ...
        super(Selection, self).setGeometry(x * self.context.currentImage().zoom - 1, y * self.context.currentImage().zoom -
                                           1, w * self.context.currentImage().zoom + 2, h * self.context.currentImage().zoom + 2)
