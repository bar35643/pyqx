...
class NewFileDialog(QtWidgets.QDialog):
    ...
    def accept(self):
        ...
        if self.r1.isChecked():
            ...
            self.context.newImage(self.width.value(),
                                  self.height.value(), self.color)
...
class ResizeCanvasDialog (QtWidgets.QDialog):
    ...
    def __init__(self, context, Parent=None):
        ...
        self.setLayout(mainLayout)
        self.setWindowTitle(self.context.getText(
            "dialog_resize_canvas", "title"))
        self.show()
...
class Preferences (QtWidgets.QDialog):
    ...
    def __init__(self, context, signals, Parent=None):
        ...
        self.preferences.addItem(self.context.getText(
            "dialog_preferences", "item_language"))
        self.preferences.addItem(self.context.getText(
            "dialog_preferences", "item_theme"))
        self.preferences.addItem(self.context.getText(
            "dialog_preferences", "item_matrix_grid"))
        self.preferences.setCurrentRow(0)
        self.preferences.currentItemChanged.connect(self.changeCurrentView)
        self.preferences.setFixedWidth(
            self.preferences.sizeHintForColumn(0) + 24)
    ...
    def createLanguageView(self):
        ...
        g = QtWidgets.QGroupBox(self.context.getText(
            "dialog_preferences", "item_language_language"))
    ...
    def createUICustomizationView(self):
        ...
        j = 0
        self.themeDirs = [d for d in os.listdir(
            "themes") if os.path.isdir(os.path.join("themes", d))]
        ...
        hbox.addWidget(QtWidgets.QLabel(self.context.getText(
            "dialog_preferences", "item_theme_theme")))
    ...
    def createMatrixGridView(self):
        ...
        g = QtWidgets.QGroupBox(self.context.getText(
            "dialog_preferences", "item_matrix_grid_dimension"))
    ...
    def accept(self):
        ...
        if self.langCodes[self.language.currentIndex()] != self.context.lang:
            QtWidgets.QMessageBox.information(self, self.context.getText(
                "dialog_preferences", "item_language_changed_title"), self.context.getText("dialog_preferences", "item_language_changed_message"))
        ...
        if self.context.getDefault("theme", "theme", "aquamarine") != self.themeDirs[self.theme.currentIndex()]:
            QtWidgets.QMessageBox.information(self, self.context.getText(
                "dialog_preferences", "item_theme_changed_title"), self.context.getText("dialog_preferences", "item_theme_changed_message"))
        self.context.setDefault(
